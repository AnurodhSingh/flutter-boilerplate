...
void main() {
  ...
  testWidgets('Login form widget initial visibility test.',
  ...
  testWidgets('Login form password validation test.',
      (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(makeTestableWidget(child: HomePage()));
  ...
  testWidgets('Login form validation test with correct values',
      (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(makeTestableWidget(child: HomePage()));
